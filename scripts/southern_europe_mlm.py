...
REGION_NAME = "SOUTHERN_EUROPE"


CORPUS_FILE_PATH = r'D:\market_data\text_data\REGIONS\SOUTHERN_EUROPE_corpus.txt' # <-- SET THIS
...
num_train_epochs = 10 # 4gb is med, let's train for 2 full passes
per_device_train_batch_size = 34 # Keep this as high as your VRAM allows
